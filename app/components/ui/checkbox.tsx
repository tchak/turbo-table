  ...
  >
    {composeRenderProps(children, (children, renderProps) => (
      <>
        <div
          className={cn(
            'flex size-4 shrink-0 items-center justify-center rounded-sm border border-neutral-900 text-current ring-offset-white dark:border-neutral-50 dark:ring-offset-neutral-950',
            /* Focus Visible */
